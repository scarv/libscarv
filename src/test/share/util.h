...
#define OPT_MP_MPN_MIN_LIMB (    6 )
#define OPT_MP_MPN_MAX_LIMB (    7 )
#define OPT_MP_MPZ_MIN_LIMB (    8 )
#define OPT_MP_MPZ_MAX_LIMB (    9 )
#define OPT_MP_MRZ_MIN_LIMB (   10 )
#define OPT_MP_MRZ_MAX_LIMB (   11 )
